...
[
    ...
    [LSTRING(set_cat_main)],
    [[0,1,2,3,4], [LSTRING(set_allowedSeats_all), LSTRING(set_allowedSeats_crew), LSTRING(set_allowedSeats_copilot), LSTRING(set_allowedSeats_pilot), LSTRING(set_allowedSeats_copilotpilot)], 4], //0=all, 1=crew, 2=copilot, 3=pilot, 4=pilot+copilot
    1,
    {},
    false
] call CBA_fnc_addSetting;
